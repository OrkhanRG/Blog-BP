...
@section('content')
    ...
    <section class="telegram d-flex align-items-center mt-5 p-4 rounded-2 text-white">
        ...
        <div class="telegram-body">
            ...
            <a href="{{isset($settings) ? $settings->telegram_links : 'javascript:void(0)'}}" target="_blank" class="btn btn-warning p-3 text-black">Telegrama Katıl</a>
        </div>
            ...
            <div class="col-md-4 mt-4">
                ...
                <div class="most-popular-body mt-2">
                    <div class="most-popular-author d-flex justify-content-between">
                        ...
                        <div class="text-end">Kategori: <a href="{{ route('front.categoryArticles', ['category' => $article->category->slug]) }}">{{ $article->category->name }}</a></div>                            </div>
                    <div class="most-popular-title">
                        <h4 class="text-black">
                            <a href="{{ route('front.articleDetail', ['user' => $article->user->username, 'article' => $article->slug]) }}">
                                {{ $article->title }}
