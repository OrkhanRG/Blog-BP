...
class EmailController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        alert()->success("Uğurlu", "$updateName Email Şablon Dəyişdirildi")
    ...
    public function changeStatus(Request $request)
    {
        ...
        return response()
            ->json([
                'status' => 'succes',
                'message' => 'Şablon Statusu Dəyişdirildi',
    ...
    public function store(Request $request)
    {
        ...
        alert()->success("Uğurlu", "Email Şablon Yaradıldı")
            ->showConfirmButton('yaxşı', '#3085d6')
            ->autoClose(5000);
        return redirect()->route('admin.email-themes.index');
    }
    ...
    {
        $list = EmailThemesActive::with('user', 'theme')->get();
        $process = EmailTheme::PROCESS;
    ...
    public function assignDelete(Request $request)
    {
        ...
        return response()
            ->json([
                'status' => 'success',
                'message' => 'Uğurlu',
                'data' => 'Seçilmiş Email Şablon Silindi'])
            ->setStatusCode(200);
    }
}
